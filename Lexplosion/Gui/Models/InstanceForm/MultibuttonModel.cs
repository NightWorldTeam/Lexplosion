...
namespace Lexplosion.Gui.Models.InstanceForm
{
    public sealed class Icon
    {
        ...
        public Icon(Geometry geometry = null, double width = 20, double height = 20)
        {
            Geometry = geometry;
            Width = width;
            Height = height;
    ...
    public class MultibuttonModel : VMBase
    {
        ...
        private Icon _upperIcon;
        private Icon _lowerIcon;
        ...
        public void ChangeFuncPlay()
            => ChangeFunc(
                    ...
                    new Icon(MultiButtonProperties.GeometryPlayIcon),
                    new Icon(MultiButtonProperties.GeometryMore),
                    "Играть", -60, null, 0
            );
        ...
        public void ChangeFuncDownload(bool isAddedToLibrary)
        {
            ...
            ChangeFunc(
                ...
                new Icon(MultiButtonProperties.GeometryDownloadIcon, 20, 20),
                new Icon(MultiButtonProperties.GeometryLibraryDelete),
        ...
        public void ChangeFuncProgressBar()
            => ChangeFunc(
                    ...
                    null, new Icon(MultiButtonProperties.GeometryCancelIcon),
        ...
        public void ChangeFuncClose()
            => ChangeFunc(
                    ...
                    new Icon(MultiButtonProperties.GeometryCancelIcon),
                    new Icon(MultiButtonProperties.GeometryOpenFolder),
                    "Закрыть игру", -100, "Открыть папку с игрой", -150
                );

        public void ChangeFunc(
            UpperButtonFunc uFunc, LowerButtonFunc lFunc, Icon uIcon,
            Icon lIcon, string uTipText, int uOffset, string lTipText, int lOffset
            )
        {
            UpperFunc = uFunc;
            LowerFunc = lFunc;
    ...
    public sealed class MultiButtonProperties
    {
        ...
        public static readonly Geometry GeometryMore = Geometry.Parse("M 0 4 H 4 V 0 H 0 V 4 Z M 6 16 H 10 V 12 H 6 V 16 Z M 0 16 H 4 V 12 H 0 V 16 Z M 0 10 H 4 V 6 H 0 V 10 Z M 6 10 H 10 V 6 H 6 V 10 Z M 12 0 V 4 H 16 V 0 H 12 Z M 6 4 H 10 V 0 H 6 V 4 Z M 12 10 H 16 V 6 H 12 V 10 Z M 12 16 H 16 V 12 H 12 V 16 Z");
        public static readonly Geometry GeometryMoreAlert = Geometry.Parse(
            "M 0 8 H 4 V 4 H 0 V 8 Z M 6 20 H 10 V 16 H 6 V 20 Z M 0 20 H 4 V 16 H 0 V 20 Z M 0 14 H 4 V 10 H 0 V 14 Z M 6 14 H 10 V 10 H 6 V 14 Z M 12 20 H 16 V 16 H 12 V 20 Z M 15 0 C 12.24 0 10 2.24 10 5 C 10 7.76 12.24 10 15 10 C 17.76 10 20 7.76 20 5 C 20 2.24 17.76 0 15 0 Z M 15.5 8 H 14.5 V 7 H 15.5 V 8 Z M 15.5 6 H 14.5 V 2 H 15.5 V 6 Z M 12 14 H 16 V 11.93 C 15.67 11.98 15.34 12 15 12 C 13.93 12 12.91 11.76 12 11.32 V 14 Z M 6 4 V 8 H 8.68 C 8.24 7.09 8 6.07 8 5 C 8 4.66 8.02 4.33 8.07 4 H 6 Z"
            );
    }
}