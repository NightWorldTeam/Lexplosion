...
namespace Lexplosion.Logic.Network.SMP
{
    class SmpClient
    {
        ...
        protected ushort maxPackagesCount = 3; //количество пакетов которое можно отправить за 1 раз. В процессе работы это значение может меняться. Чем стабльнее сеть, тем оно выше
