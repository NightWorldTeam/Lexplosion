...
namespace Lexplosion.WPF.NewInterface.Mvvm.Models.Mvvm.InstanceModel
{
    public class InstanceModelArgs 
    {
        ...
        public InstanceModelArgs(AppCore appCore, InstanceClient instanceClient, Action<InstanceClient> exportFunc, Action<InstanceModelBase> setRunningGame, InstanceDistribution instanceDistribution = null, ImportData? importData = null, InstancesGroup? group = null, InstanceLocation instanceLocation = InstanceLocation.Library)
        {
            AppCore = appCore;
